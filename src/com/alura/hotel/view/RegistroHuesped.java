...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped(int idReserva) {
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				String nombreH = RegistroHuesped.txtNombre.getText();
				String apellidoH = RegistroHuesped.txtApellido.getText();
				Date fechaNacimientoH = RegistroHuesped.txtFechaN.getDate();
				Object nacionalidadH = RegistroHuesped.txtNacionalidad.getSelectedItem();
				String telefonoH = RegistroHuesped.txtTelefono.getText();
				if (nombreH != null && apellidoH != null && fechaNacimientoH != null && nacionalidadH != null
						&& telefonoH != null) {
					...
					huespedController.guardarHuesped(huesped, idReserva);
					JOptionPane.showMessageDialog(null, "Su reserva fue realizada exitosamente");
